    ...
    function ($, _, mageTemplate) {
        ...
        return {
            ...
            build: function (formData) {
                var formTmpl = mageTemplate('<form action="<%= data.action %>" id="glocash_payment_form"' +
            ...
            makeInline: function (form) {
                ...
                var use_inline_input = this.makeElement('input', {
                    name: 'glocash_use_inline',
                    type: 'hidden',
                    value: '1'
                });
                form.append(use_inline_input);
                if (!is_mobile()) {
                    form.attr('target', 'glocash_lightbox_iframe');
                } else {
                    var inline_mobile = this.makeElement('input', {
                        name: 'glocash_inline_mobile',
                        type: 'hidden',
                        value: '1'
                    });
