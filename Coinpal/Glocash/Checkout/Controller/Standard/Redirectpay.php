...
class Redirectpay extends \Glocash\Checkout\Controller\Pay
{
    ...
    public function execute()
    {
		...
		try {
			...
			Logs::logw("#".$quote->getReservedOrderId()." order_id:".$orderId,"glocash.log","Create_order");


		} catch (\Exception $e) {
			Logs::logw("#".$quote->getReservedOrderId()." ".json_encode($e->getMessage()),"glocash.log","Error");
		}
